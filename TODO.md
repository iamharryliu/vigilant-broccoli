...
### 9cbd33. Socket-server hardening
...
### 91e45c. Deprecated Nx executors/plugins not yet migrated (removed in Nx v24)
...
### 5bdea5. Vite/Angular bundle-size warnings
...
### 1f0a7e. Next.js "inferred workspace root" warning
...
### 16815c. `vb-manager-next`: Supabase Google sign-in has no allowlist — accepted risk (not fixed)
