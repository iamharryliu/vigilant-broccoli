...
def main():
    ...
    body = (
        f"Today's weather is {weather_data['weather']['description']}, {weather_data['weather']['temp_min']}C to {weather_data['weather']['temp_max']}C.\n\n"
        + f"Currently {weather_data['weather']['temp']}C.\n"
        + f"Feels like {weather_data['weather']['feels_like']}C.\n\n"
        + f"{weather_data['weather']['clouds']}% Cloudiness\n{weather_data['weather']['humidity']}% Humidity\n\n"
