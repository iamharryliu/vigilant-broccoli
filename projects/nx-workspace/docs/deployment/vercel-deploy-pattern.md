...
Deploys for `hearth`, `findme`, `whiteboard`, `employee-handler-ui`. Everything runs through `scripts/deploy-vercel.ts`; app-side requirements (i18n, cards) are in [ui-app-pattern.md](../ui/ui-app-pattern.md).
