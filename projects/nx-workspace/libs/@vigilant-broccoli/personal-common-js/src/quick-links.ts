...
const UTILITY_LINKS = [
  ...
  {
    label: PROTON_LINK.CALENDAR.NAME,
    target: PROTON_LINK.CALENDAR.URL,
    type: OPEN_TYPE.BROWSER,
    subgroup: LINK_GROUP_SUBGROUP.UTILITY,
  },
  {
    label: PROTON_LINK.DRIVE.NAME,
    target: PROTON_LINK.DRIVE.URL,
    type: OPEN_TYPE.BROWSER,
    subgroup: LINK_GROUP_SUBGROUP.UTILITY,
  },
  {
    label: PROTON_LINK.PASS.NAME,
    target: PROTON_LINK.PASS.URL,
    type: OPEN_TYPE.BROWSER,
    subgroup: LINK_GROUP_SUBGROUP.UTILITY,
  },
  {
    label: PROTON_LINK.ACCOUNT.NAME,
    target: PROTON_LINK.ACCOUNT.URL,
    type: OPEN_TYPE.BROWSER,
    subgroup: LINK_GROUP_SUBGROUP.UTILITY,
  },
  {
