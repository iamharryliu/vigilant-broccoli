...
export const APP_ACTION = {
  ...
  HELP_DEMO_SCHEDULE: 'HELP_DEMO_SCHEDULE',
  HELP_DEMO_EVENT: 'HELP_DEMO_EVENT',
  HELP_DEMO_LUNCH: 'HELP_DEMO_LUNCH',
  HELP_DEMO_SETTINGS: 'HELP_DEMO_SETTINGS',
  SELECT_DEFAULT_OFFICE: 'SELECT_DEFAULT_OFFICE',
};
