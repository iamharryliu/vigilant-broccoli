...
const DEV_LINKS = [
  ...
  {
    label: GCP_LINK.AUTH_AUDIENCE.NAME,
    target: GCP_LINK.AUTH_AUDIENCE.URL,
    type: OPEN_TYPE.BROWSER,
    subgroup: LINK_GROUP_SUBGROUP.DEV,
  },
  {
  ...
  {
    label: ELEVENLABS_LINK.DASHBOARD.NAME,
    target: ELEVENLABS_LINK.DASHBOARD.URL,
    type: OPEN_TYPE.BROWSER,
    subgroup: LINK_GROUP_SUBGROUP.DEV,
  },
  {
    label: ELEVENLABS_LINK.API_KEYS.NAME,
    target: ELEVENLABS_LINK.API_KEYS.URL,
    type: OPEN_TYPE.BROWSER,
    subgroup: LINK_GROUP_SUBGROUP.DEV,
  },
  {
