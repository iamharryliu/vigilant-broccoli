create table kitchen_chore_items (
...
alter table kitchen_chore_items enable row level security;

create policy "Users can manage kitchen chore items for their homes"
  on kitchen_chore_items
  for all
  using (
    home_id in (
