...
[![cron-utility-backup-repo](https://github.com/iamharryliu/vigilant-broccoli/actions/workflows/cron-utility-backup-repo.yml/badge.svg)](https://github.com/iamharryliu/vigilant-broccoli/actions/workflows/cron-utility-backup-repo.yml)\
...
[![test-smoke-email-subscription-service](https://github.com/iamharryliu/vigilant-broccoli/actions/workflows/test-smoke-email-subscription-service.yml/badge.svg)](https://github.com/iamharryliu/vigilant-broccoli/actions/workflows/test-smoke-email-subscription-service.yml)\
...
[![test-smoke-llm](https://github.com/iamharryliu/vigilant-broccoli/actions/workflows/test-smoke-llm.yml/badge.svg)](https://github.com/iamharryliu/vigilant-broccoli/actions/workflows/test-smoke-llm.yml)\
[![test-smoke-rabbitmq](https://github.com/iamharryliu/vigilant-broccoli/actions/workflows/test-smoke-rabbitmq.yml/badge.svg)](https://github.com/iamharryliu/vigilant-broccoli/actions/workflows/test-smoke-rabbitmq.yml)\
[![test-smoke-socket-server-socketio](https://github.com/iamharryliu/vigilant-broccoli/actions/workflows/test-smoke-socket-server-socketio.yml/badge.svg)](https://github.com/iamharryliu/vigilant-broccoli/actions/workflows/test-smoke-socket-server-socketio.yml)\
[![test-smoke-storage-service](https://github.com/iamharryliu/vigilant-broccoli/actions/workflows/test-smoke-storage-service.yml/badge.svg)](https://github.com/iamharryliu/vigilant-broccoli/actions/workflows/test-smoke-storage-service.yml)\
