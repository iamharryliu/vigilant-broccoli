...
| **Bloom**         | To heat whole or ground spices in fat (or toast them dry) until fragrant, dissolving their fat-soluble flavor compounds so they spread through the dish instead of tasting raw and dusty. Also used for softening gelatin in cold liquid before dissolving it, and for the dull gray film that forms on chocolate stored badly. |
...
| -------------- | ----------------------------------------------------------------------------------------------------- |
| **Slice**      | Cutting food into flat pieces, thin or thick depending on the application.                            |
| **Chop**       | Rough, quick cuts into medium or large irregular pieces.                                              |
| **Dice**       | Cutting food into uniform cubes. The size can vary depending on the recipe (small, medium, or large). |
| **Mince**      | Very fine, tiny pieces—often used for garlic, herbs, and aromatics.                                   |
| **Batonnet**   | Thick matchstick-shaped pieces, about ¼ inch (6 mm) thick.                                            |
...
| Term                              | Description                                                                                                                                                                                                                                                                                                     |
| --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Chinkiang (Zhenjiang) Vinegar** | A traditional Chinese aged black rice vinegar with a deep, malty, slightly smoky flavor. Commonly used in dumpling dipping sauces, sweet-and-sour dishes, braises, and to add acidity that balances rich flavors.                                                                                               |
...
| **Gochujang**                     | A thick Korean fermented chili paste made from red chili powder, glutinous rice, fermented soybeans, and salt. It has a spicy, sweet, and savory flavor and is commonly used in marinades, stews, sauces, and bibimbap.                                                                                         |
...
| **Miso**                          | A traditional Japanese fermented soybean paste made with soybeans, salt, kōji, and often rice or barley. It provides a rich umami flavor and is commonly used in soups, marinades, glazes, dressings, and sauces.                                                                                               |
| **Sambal Oelek**                  | An Indonesian chili paste made primarily from fresh red chilies, vinegar, and salt. It delivers clean chili heat and is commonly used in stir-fries, marinades, dipping sauces, and soups.                                                                                                                      |
| **Shaoxing Wine**                 | A traditional Chinese rice cooking wine made from fermented glutinous rice. Used in braises, stir-fries, marinades, and sauces to add aroma, depth, and complexity while helping reduce meaty odors.                                                                                                            |
