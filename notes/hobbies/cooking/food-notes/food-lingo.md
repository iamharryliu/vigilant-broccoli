...
| Term      | Description                                                                                                                                                                                                                                    |
| --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Blanching | A cooking technique in which food is briefly boiled and then immediately transferred to ice water to stop the cooking process. Commonly used to preserve color, texture, and nutrients in vegetables, or to loosen skins from fruits and nuts. |
| Brining   | The process of soaking food, typically meat or poultry, in a saltwater solution (often with sugar, herbs, or spices) before cooking to improve moisture retention, seasoning, and tenderness.                                                  |
| Deglazing | The process of pouring liquid (wine, broth, or water) into a hot pan to loosen and dissolve the browned, caramelized bits of food stuck to the bottom. Creates a flavorful sauce or gravy.                                                     |
| Pickling  | A food preservation method that uses an acidic solution (typically vinegar) or fermentation in a salt brine to preserve food while developing a tangy flavor. Commonly used for vegetables, fruits, eggs, and fish.                            |

## Types of Cuts

| Term       | Brief Description                                                                                     | Image |
| ---------- | ----------------------------------------------------------------------------------------------------- | ----- |
