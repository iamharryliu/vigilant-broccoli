...
| [Tailscale](../network-security/tailscale.md) | Mesh VPN (WireGuard-based) with automatic peer discovery/ACLs, hosted control plane                     | Free for 3 users / 100 devices, see [tailscale.md](../network-security/tailscale.md#free-tier) | Ad hoc mesh access across many devices/services without managing keys/routes by hand   |
