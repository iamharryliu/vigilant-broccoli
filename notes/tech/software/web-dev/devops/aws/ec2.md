...
- EC2: 750 hrs/month of t2.micro/t3.micro — first 12 months of the account only. Anything larger is always billed: a `t3.small` (2 GB, the practical floor for a Grafana + Loki box) is ≈ $15/month in eu-north-1, an Elastic IP attached to a running instance is free.
