...
- Each app under `apps/*` carries a `README.md` following [app-readme-pattern.md](./app-readme-pattern.md) (title, one-line purpose, `## Stack`); keep it in sync with the code. Run `/update-app-readmes` to review and refresh them all.
  D
