...
subgraph HOMELAB_PI[Homelab Pi]
  JELLYFIN[Jellyfin]
  MEDIA_DRIVE[(External Media Drive)]
  JELLYFIN-->MEDIA_DRIVE
end
...
USER-->WIREGUARD
USER-->TAILSCALE[Tailscale]-->JELLYFIN
...
DEPLOYED_SERVERLESS_SERVICES-->API_SERVICES

GITHUB_ACTIONS-->DEPENDENCY_DISTRIBUTION
GITHUB_ACTIONS-->GCP_SA

API_SERVICES-->CLOUDFLARE
API_SERVICES-->LLM_SERVICES
API_SERVICES-->DB_SERVICES
API_SERVICES-->MESSAGE_SERVICES
API_SERVICES-->UTILITY_SERVICES
API_SERVICES-->MONEY_SERVICES
