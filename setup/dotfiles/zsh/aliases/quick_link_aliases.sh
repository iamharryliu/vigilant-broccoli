...
alias chatgpt='open -a "Google Chrome" "https://chat.openai.com/"'
...
# Learning
alias udemy='open -a "Google Chrome" "https://www.udemy.com/"'
alias memrise='open -a "Google Chrome" "https://app.memrise.com/dashboard"'
...
# Investment
alias questtrade='open -a "Google Chrome" "https://login.questrade.com/account/login"'
# Credit Accounts
