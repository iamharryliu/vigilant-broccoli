...
4. Integrate, based on where HEAD is:
   ...
   - On a feature branch: `git merge --no-edit origin/main`. Merge, never rebase — `CLAUDE.md`'s `## Git` section explains why.
